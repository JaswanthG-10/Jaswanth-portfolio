...
import { Rocket, FileText, Film, CheckSquare, Landmark, Github, ExternalLink, Info } from 'lucide-react';
import { independentProjects } from '../data/portfolioData';
...
export const Projects = () => {
  ...
  const filteredProjects = independentProjects.filter(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          >
            ...
            <span>Independent Systems & Applications</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 15 }}
            animate={isVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 15 }}
          ...
          >
            Software <span className="bg-gradient-to-r from-white via-[#F43F5E] to-[#06B6D4] bg-clip-text text-transparent">Engineering Projects</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 15 }}
            animate={isVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 15 }}
          ...
          >
            Independently engineered applications across document intelligence, recommendation systems, backend APIs, and relational databases.
          </motion.p>
        </div>
