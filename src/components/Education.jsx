    ...
    <section id="education" className="py-24 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Education & <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-sky-500 bg-clip-text text-transparent">Academic Foundation</span>
          </motion.h2>
        </div>
        ...
        >
          <GlassCard className="p-8 sm:p-10 rounded-3xl shadow-glass border-white/90 relative overflow-hidden animate-float-1">
            
            {/* Background Pastel Aura */}
            <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-bl from-indigo-100/50 via-sky-100/40 to-transparent rounded-full blur-2xl -z-10" />
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pb-6 border-b border-slate-200/60">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-indigo-500 via-purple-500 to-sky-400 p-0.5 shadow-md shrink-0">
              ...
              <div className="flex flex-col items-start sm:items-end text-xs font-semibold text-slate-500 gap-1 shrink-0">
                <span className="glass-pill px-3.5 py-1 rounded-full text-indigo-700 font-bold bg-indigo-50 border-indigo-200 flex items-center gap-1.5">
            ...
            <div className="pt-6">
              <h4 className="text-xs font-extrabold uppercase text-slate-500 tracking-wider mb-4">
                Academic Specialization & Activities
              </h4>

              <div className="space-y-3">
                {educationData.highlights.map((highlight, idx) => (
                  <div key={idx} className="flex items-start gap-3 bg-white/70 backdrop-blur-md p-3.5 rounded-2xl border border-white shadow-sm">
